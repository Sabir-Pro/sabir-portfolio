...
if (studio && studioViewport) {
  ...
  const updateStudio = () => {
    ...
    studio.style.setProperty('--studio-stage-y', `${(-70 * p).toFixed(1)}px`);
    studio.style.setProperty('--studio-scale', (1 + p * 0.035).toFixed(4));
    studio.style.setProperty('--studio-center-z', `${(80 + p * 190).toFixed(1)}px`);
    studio.style.setProperty('--studio-side-z', `${(p * 55).toFixed(1)}px`);
    studio.style.setProperty('--studio-center-rot', `${(p * -1.8).toFixed(2)}deg`);
    studio.style.setProperty('--studio-left-rot', `${(20 + p * 8).toFixed(2)}deg`);
    studio.style.setProperty('--studio-right-rot', `${(-20 - p * 8).toFixed(2)}deg`);
    studio.style.setProperty('--studio-glow-a', (0.10 + p * 0.13).toFixed(3));
    studio.style.setProperty('--studio-glow-b', (0.08 + p * 0.12).toFixed(3));
    studio.style.setProperty('--studio-beam-a', (0.08 + p * 0.10).toFixed(3));
    studio.style.setProperty('--studio-beam-b', (0.08 + p * 0.10).toFixed(3));
    studio.style.setProperty('--studio-glow-ax', `${(p * 70).toFixed(1)}px`);
    studio.style.setProperty('--studio-glow-ay', `${(-p * 30).toFixed(1)}px`);
    studio.style.setProperty('--studio-glow-bx', `${(-p * 60).toFixed(1)}px`);
    studio.style.setProperty('--studio-glow-by', `${(p * 35).toFixed(1)}px`);
    studio.style.setProperty('--studio-beam-ax', `${(p * 40).toFixed(1)}px`);
    studio.style.setProperty('--studio-beam-bx', `${(-p * 40).toFixed(1)}px`);
    studio.style.setProperty('--studio-light', (0.16 + p * 0.24).toFixed(3));
    studio.style.setProperty('--studio-light-scale', (0.8 + p * 0.55).toFixed(3));
    studioTicking = false;
  };
  addEventListener('scroll', () => {
